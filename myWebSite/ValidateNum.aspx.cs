...
public partial class ValidateNum : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            HttpCookie cookie = Request.Cookies["validateNum"];
            if (cookie == null)
            {
                cookie = new HttpCookie("validateNum");
            }
            cookie.Value = validateNum;
            cookie.Expires = System.DateTime.Now.AddMinutes(30);
