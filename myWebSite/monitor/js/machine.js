window.onload = function () {
    ...
    var categoryName = { '监控': 'clamp', '模具': 'clamp', '顶针': 'ejector', '注射': 'injection', '中子': 'core', '座台': 'carriage', '温度': 'temperature', '统计': 'analysis', '质量': 'analysis', '机器使用': 'analysisUsage', '机器状态': 'analysisStatus', '机器异常': 'analysisAlarm', "机器信息": "machineInfoBasic", "机器规格": "machineInfo", "基本信息": "machineInfoBasic", "控制信息": "controlInfo" };
    var mahineID = '';
    myChart.showLoading();
